...
- Execute only one approved infra item at a time in a dedicated worktree.
- Review source, scope, and verification compliance before a local commit.
...
`2026-03-28`. The optional Codex role presets and archived supervisor backlog
were removed on `2026-09-20`; manual work uses `AGENTS.md` and the roadmaps.
Do not reintroduce background scheduling or auto-commit behavior without
