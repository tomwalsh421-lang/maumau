...
carry that stored coverage, how fresh the covered reports are, and whether any
current rows still contain unmatched availability records, but the metadata is
descriptive only and does not change qualification, ranking, or staking.
